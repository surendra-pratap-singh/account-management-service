...
public class ErrorHandler {
    ...
    @ResponseBody
    public Object insufficientFundsException(Exception ex) {
    ...
    @ResponseBody
    public Object internalServerErrorException(Exception ex) {
    ...
    @ResponseBody
    public Object invalidCurrencyException(Exception ex) {
    ...
    @ResponseBody
    public Object returnInvalidRequest(Exception ex) {
    ...
    @ResponseBody
    public Object resourceNotFoundException(Exception ex) {
